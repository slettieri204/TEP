...
class Datatable(six.with_metaclass(DatatableMetaclass)):
    ...
    def search(self, queryset):
        ...
        print("self.config['search']",self.config['search'])
        ...
        for term in searches.keys():
            ...
            if term_queries:
                print("term_queries before",term_queries)
                table_queries.append(reduce(operator.or_, term_queries))
                print("term_queries after",term_queries)

        if table_queries:
            print("table_queries before",table_queries)
            q = reduce(operator.and_, table_queries)
            print("datatable Q IS",q)
